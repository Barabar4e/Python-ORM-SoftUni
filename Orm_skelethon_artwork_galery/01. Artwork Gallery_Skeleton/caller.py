...
def show_highest_rated_art():
	max_rating_art = ArtworkGallery.objects.order_by('-rating', 'id').first()

	return f"{max_rating_art.art_name} is the highest-rated art with a {max_rating_art.rating} rating!"
